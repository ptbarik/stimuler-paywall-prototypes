...
/* ── the tier toggle ──────────────────────────────────────────────────
   In the header now, not inside the price sheet. It is the first thing under
   the close button, so the tier is chosen before anything is read rather than
   discovered halfway down the sheet — and the caption, the hero pill and the
   whole page re-theme off it. */
...
/* ── the price sheet ──────────────────────────────────────────────────
   Just the two plans now — 57px shorter than it was, and starting 57px lower,
   so the cards themselves land on exactly the same page coordinates as before. */
...
export function Social() {
  return (
    <>
      <div className="chip s3" style={{ top: 1354.5 }}>
...
export function Faq({ onResize }) {
  ...
  return (
    <>
      <div className="chip s3" style={{ top: 2054 }}>
